...
interface Props { produit: any; categories: any[]; sousCategories: any[]; fournisseurs: string[] }

export default function FormulaireModifier({ produit, categories, sousCategories, fournisseurs }: Props) {
